...
Deployment will be phased the following way

== Phase 1

[plantuml, {plantumldir}phase1_deployment, svg, opts="inline"]     
----
include::{structurizrdir}/phase1_deployment.plantuml[]
----

The component grabbing feeds is deployed on developer machine

== Phase 2

[plantuml, {plantumldir}phase2_deployment, svg, opts="inline"]     
----
include::{structurizrdir}/phase2_deployment.plantuml[]
----

Feed graber, feed presenter and database are all deployed on user machine.


== Phase 3

[plantuml, {plantumldir}phase3_deployment, svg, opts="inline"]     
----
include::{structurizrdir}/phase3_deployment.plantuml[]
----

Now we have one centralized feed graber running on a central serve,
and feed presenter running on developper machine.
A centralized database stores all informations.

== Phase 4

[plantuml, {plantumldir}phase4_deployment, svg, opts="inline"]     
----
include::{structurizrdir}/phase4_deployment.plantuml[]
----

Feed graber, feed presenter and database are all deployed on a Docker compose environment.
