...
{project-issues-on-github}/new?title=Error%20in%20{project-artifact-id}%20v.{project-version}%20chapter%20{chapter}[icon:github[set=fab] enter an issue on GitHub,window=feedback].
endif::[]
ifeval::["{project-issues-on-gitlab}"!=""]
[TIP]
If you encounter any error, feel free to
{project-issues-on-gitlab}/new?title=Error%20in%20{project-artifact-id}%20v.{project-version}%20chapter%20{chapter}[icon:gitlab[set=fab] enter an issue on GitLab,window=feedback].
endif::[]
