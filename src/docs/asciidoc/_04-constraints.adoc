...
Application should be in production in july.
Each learner will develop its own version.

Approved technology lists and technology constraints::
Backend code should be built in Python.
Frontend code should been built using htmx

Target deployment platform::
* Google Compute Engine
* Google Kubernetes Engine
* AWS Elastic Compute
* AWS Elastic Kubernetes Engine
