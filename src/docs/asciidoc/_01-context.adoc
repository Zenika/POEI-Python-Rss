= Context
:chapter: Context
:structurizrdir: ../../../target/structurizr/diagrams
:plantumldir: ../../../target/asciidoc/docs/html
...
This system allow users to have updated views of the RSS feeds they want to consume in their browser
////
